...
m_SMM_full <- glm(severe_stg ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + pat_race + ethnicity + ADI + admission_stage, data = df, family = 'binomial')
...
m_SMM_no_race <- glm(severe_stg ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + ADI + admission_stage, data = df, family = 'binomial')
...
# Model without ADI  
m_SMM_no_ADI <- glm(severe_stg ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + pat_race + ethnicity + admission_stage, data = df, family = 'binomial')
...
m_SMM_noADIorRace <- glm(severe_stg ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + admission_stage, data = df, family = 'binomial')
...
m_LOS_full <- lm(hospital_LOS ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + pat_race + ethnicity + ADI + admission_stage, data = df)
...
# Model without race/ethnicity 
m_LOS_no_race <- lm(hospital_LOS ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + ADI + admission_stage, data = df)
...
# Model without ADI  
m_LOS_no_ADI <- lm(hospital_LOS ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + pat_race + ethnicity + admission_stage, data = df)
...
# Model without ADI or race/ethnicity 
m_LOS_noADIorRace <- lm(hospital_LOS ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + admission_stage, data = df)
...
m_readmit_full <- glm(readmit ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + pat_race + ethnicity + ADI + admission_stage, data = df, family = 'binomial')
...
# Model without race/ethnicity 
m_readmit_no_race <- glm(readmit ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + ADI + admission_stage, data = df, family = 'binomial')
...
# Model without ADI  
m_readmit_no_ADI <- glm(readmit ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + pat_race + ethnicity + admission_stage, data = df, family = 'binomial')
...
# Model without ADI or race/ethnicity 
m_readmit_noADIorRace <- glm(readmit ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + admission_stage, data = df, family = 'binomial')
