---
title: "Regression Analysis for Demog-Staging-ADI Data -- Secondary Outcome: Readmission"
...
## Description
This file reads in the demographics, Covid staging, and ADI data (`dm_stg_adi_7.19.21.rds`) and fits a logistic regression model with readmission (`readmit`) as the outcome. Primary and secondary outcomes for full regression analysis can be found below. 
...
# Compare full and null models -- Readmission (`readmit`)
...
# Generate simple logistic regressions for readmission
