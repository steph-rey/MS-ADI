...
## Description
This file reads in the demographics, Covid staging, and ADI data (`dm_stg_adi_7.19.21.rds`) and fits a logistic regression model using severe morbidity and mortality as the outcome. Primary and secondary outcomes for full regression analysis can be found below. 
