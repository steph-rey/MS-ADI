...
# FULL MODEL 
m_full_readmit <- glm(readmit ~ age + sex + smoking + cci_total + marital_status + language + insurance_type + pat_race + ethnicity + ADI + admission_stage, data = df, family = 'binomial')
